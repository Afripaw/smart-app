  ...
  create: accessProcedure(["System Administrator", "Data Analyst", "Treatment Data Capturer", "General Data Capturer"])
    .input(
      z.object({
        ...
        vaccination1Type: z.string().array(),
        vaccination2Type: z.string().array(),
        vaccination3Type: z.string().array(),
        vaccination1Paid: z.string(),
        vaccination2Paid: z.string(),
      ...
      const pet = await ctx.db.$transaction(async (prisma) => {
        ...
        const createdPet = await prisma.pet.create({
          data: {
            ...
            vaccination1Type: input.vaccination1Type,
            vaccination2Type: input.vaccination2Type,
            vaccination3Type: input.vaccination3Type,
        ...
        if (term.match(/^P\d+$/) !== null) {
          return {
            OR: [
              ...
              { vaccination1Type: { hasSome: [term] } },
              { vaccination2Type: { hasSome: [term] } },
              { vaccination3Type: { hasSome: [term] } },
