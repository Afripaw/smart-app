...
const User: NextPage = () => {
  ...
  const allCharacters = lowerCaseLetters + upperCaseLetters + specialCharacters + numberCharacters;
          ...
          <>
            ...
            <div className="flex grow flex-col items-center">
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="relative my-2 flex w-full flex-col rounded-lg border-2 p-4">
                  ...
                  {!isUpdatePassword && (
                    <div className="flex items-center">
                      ...
                      <input
                        ...
                        value={password}
                      />
                      <button onClick={handleAutogeneratePassword} className="mx-3 rounded-lg bg-main-orange p-1 px-2">
                ...
                <div className="relative my-2 flex w-full flex-col rounded-lg border-2 p-4">
                  <div className="absolute left-0 top-0">
                    <Image
                      ...
                      alt="Afripaw Logo"
                      className="ml-auto aspect-square h-max rounded-full border-main-orange"
                      width={50}
                      height={50}
                    />
                  </div>
                  <div className="absolute right-4 top-16">
                    {user.data?.image ? (
                      <Image src={user.data?.image} alt="Afripaw profile pic" className="ml-auto aspect-auto " width={100} height={140} />
                    ) : (
                ...
                <div className="my-2 flex w-full flex-col rounded-lg border-2 p-4">
                  ...
                  <div className="flex items-start divide-x-2 divide-gray-300">
                    ...
                    <div className=" flex w-96 flex-col pl-4">
                      ...
                      <div className=" mt-3 focus:border-black">{addressFreeForm}</div>
                    </div>
                  </div>
                </div>
